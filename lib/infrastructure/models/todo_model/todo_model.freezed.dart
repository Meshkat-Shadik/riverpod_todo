...
class _$TodoTearOff {
  ...
  _Todo call({String? description, String? id, bool? completed}) {
    return _Todo(
...
class _$_Todo implements _Todo {
  const _$_Todo({this.description, this.id, this.completed});
...
abstract class _Todo implements Todo {
  const factory _Todo({String? description, String? id, bool? completed}) =
      _$_Todo;
